...
class DocCreationForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        user = super(DocCreationForm, self).save(commit=False)
...
class DocChangeForm(forms.ModelForm):
...
admin.site.register(models.Doctor, UserAdmin)
